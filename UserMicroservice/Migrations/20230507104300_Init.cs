        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Addresses_HomeAddresses_HomeAddressId",
                        column: x => x.HomeAddressId,
                        principalTable: "HomeAddresses",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Addresses_OfficeAddresses_OfficeAddressId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ChangeEmailTokens_Users_UserId",
                        column: x => x.UserId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_EmailVerificationsTokens", x => x.Id);
                    table.ForeignKey(
                        name: "FK_EmailVerificationsTokens_Users_UserId",
                        column: x => x.UserId,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                ...
                unique: true,
                filter: "[OfficeAddressId] IS NOT NULL");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ChangeEmailTokens_UserId",
                table: "ChangeEmailTokens",
                column: "UserId",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_EmailVerificationsTokens_UserId",
                table: "EmailVerificationsTokens",
                column: "UserId",
                unique: true);
