...
import {
    ...
    AddNewAddressCard, AddressCard, DeleteAccount, Avatar, AddNewPaymentCard
} from "./account";
...
export {
    ...
    AccountProfile, ChangeEmail, ChangeName, ChangePassword, AddNewAddressCard, AddressCard, DeleteAccount, Avatar, AddNewPaymentCard,
