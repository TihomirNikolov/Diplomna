    ...
    return (
        <div className="relative flex items-center">
            ...
            {props.isPassword &&
                ...
                cursor-pointer absolute z-10 right-6 bottom-4`} id="togglePassword"
                    onClick={() => { setIsPasswordVisible(!isPasswordVisible) }} />
            }
            {props.tooltip != null && props.tooltip != "" &&
                <Tooltip text={props.tooltip}
                    position="right">
                    <FontAwesomeIcon data-tooltip-target="password-tooltip" icon={['fas', 'circle-info']} size="sm" className="ml-1" />
                </Tooltip>}
        </div>
    )
}